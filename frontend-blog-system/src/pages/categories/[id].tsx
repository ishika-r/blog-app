...
import CategoriesListing from "../blogs/CategoriesListing";
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-8">
          <h2>{category?.category_title} Blogs</h2>
          <hr />
          {category?.blogs?.length > 0 ? (
            <>
              {category?.blogs?.map((blog: any) => (
                      ...
                      <div className="d-flex flex-column gap-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <div>
                            <a
                              href=""
                              className="text-decoration-none text-dark f-14"
                            >
                              {blog?.user?.name}
                            </a>
                          </div>
            ...
            <h5>No Blog found in this category</h5>
          )}
        </div>
